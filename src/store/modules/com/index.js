...
export default {
  ...
  actions: {
    ...
    setTransportTabbar({ commit }, tabbar) {
      commit(types.TRANSPORT_TABBAR, tabbar)
    },
  ...
  mutations: {
    ...
    [types.TRANSPORT_TABBAR](state, payload) {
      state.transportTabbar = payload
    },
  ...
  getters: {
    ...
    transportTabbar(state) {
      return state.transportTabbar
    },
    commonTabbar(state) {
