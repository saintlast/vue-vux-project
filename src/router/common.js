...
const TransportLayout = r => require(['@/views/common/TransportLayout'], r)
...
// 车队管理布局页
const transportChilds = deCentralization(require.context('./', true, /\.\/transport\/\w+\.js/))
...
const routes = [{
  ...
  redirect: '/transport/home',
  children: transportChilds,
  meta: { auth: true, name: 'transportLayout' }
}, {
  path: '*',
  name: 'redirect',
  redirect: to => {
